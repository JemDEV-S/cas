...
class UpdatePositionCodeRequest extends FormRequest
{
    ...
    {
        $positionCodeId = $this->route('positioncode') ?? $this->route('id');
        ...
        return [
            'code' => [
                ...
                'max:50',
                'regex:/^[A-Z0-9\-]+$/',
                Rule::unique('position_codes', 'code')
                    ->ignore($positionCodeId)
                    ->whereNull('deleted_at'),
            ],
            'name' => 'sometimes|required|string|max:255',
            'description' => 'nullable|string|max:1000',
            'base_salary' => 'sometimes|required|numeric|min:0.01|max:99999999.99',
