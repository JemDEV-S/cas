        ...
        <div class="glass-card rounded-3xl shadow-2xl overflow-hidden transform hover:shadow-3xl transition-all duration-300">
            ...
            <div class="p-8 sm:p-10">
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <!-- Olvidé contraseña -->
                    @if (Route::has('password.recover.start'))
                    <div class="flex items-center justify-end">
                        <a href="{{ route('password.recover.start') }}" class="text-sm font-medium text-[#3484A5] hover:text-[#2CA792] transition-colors duration-200">
