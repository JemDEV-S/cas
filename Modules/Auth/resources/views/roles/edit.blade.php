...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Editar Rol: {{ $role->name }}</h2>
        <p class="mt-1 text-sm text-gray-600">Modifica la información y permisos del rol</p>
    </div>
    ...
    <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('roles.show', $role) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Cancelar
                </a>
