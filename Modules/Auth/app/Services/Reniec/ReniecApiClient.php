...
class ReniecApiClient
{
    ...
    public function queryDni(string $dni): ReniecPersonDataDTO
    {
        ...
        try {
            ...
            // Deshabilitar verificación SSL si está configurado (útil si hay problemas con certificados en el servidor)
            // ADVERTENCIA: Solo usar si es necesario. Reducir seguridad.
