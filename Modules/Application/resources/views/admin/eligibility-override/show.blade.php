        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('admin.eligibility-override.view-sheet', $application->id) }}"
                       target="_blank"
                       class="bg-indigo-500 hover:bg-indigo-700 text-white px-4 py-2 rounded inline-flex items-center">
