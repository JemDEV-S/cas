        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-1 sm:items-center" x-data="{ openDropdown: null }" @click.away="openDropdown = null">
                    ...
                    <!-- Jurados -->
                    @if(auth()->user()->hasAnyPermission(['jury.view.members', 'jury.manage.assignments', 'jury.manage.conflicts']))
                    <div class="relative">
                        <button @click="openDropdown = openDropdown === 'jurados' ? null : 'jurados'"
                                class="inline-flex items-center justify-center px-3 py-2 rounded-lg text-sm font-medium transition-all
                                     {{ request()->routeIs('jury-members.*') || request()->routeIs('jury-assignments.*') || request()->routeIs('jury-conflicts.*')
                            ...
                            Jurados
                            <svg class="w-4 h-4 ml-1 transition-transform" :class="openDropdown === 'jurados' ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                            </svg>
                        </button>

                        <div x-show="openDropdown === 'jurados'"
                             x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 scale-95"
                             x-transition:enter-end="opacity-100 scale-100"
                             x-transition:leave="transition ease-in duration-150"
                             ...
                             style="display: none;">
                            <div class="py-1">
                                @can('jury.view.members')
                                <a href="{{ route('jury-members.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 transition-all group">
                                    ...
                                    <span class="font-medium group-hover:text-teal-500">Miembros de Jurado</span>
                                </a>
                                @endcan
                                @can('jury.manage.assignments')
                                <a href="{{ route('jury-assignments.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all group">
                                    <svg class="w-5 h-5 mr-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                                    </svg>
                                    <span class="font-medium group-hover:text-blue-500">Asignaciones</span>
                                </a>
                                @endcan
                                @can('jury.manage.conflicts')
                                <a href="{{ route('jury-conflicts.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-amber-50 hover:to-orange-50 transition-all group">
                                    ...
                                    <span class="font-medium group-hover:text-amber-500">Conflictos de Interés</span>
                                </a>
                                @endcan
                            </div>
                        </div>
                            ...
                            <div class="py-1">
                                ...
                                <a href="{{ route('evaluation.bulk-edit.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all group">
                                    ...
                                    <span class="font-medium group-hover:text-indigo-500">Edición Masiva</span>
                                </a>
                                @endcan
                                @can('viewAny', \Modules\Evaluation\Policies\AutomaticEvaluationPolicy::class)
                                <div class="border-t border-gray-200 my-1"></div>
                                <a href="{{ route('evaluation.automatic.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 transition-all group">
                    ...
                    <div class="relative">
                        <button @click="openDropdown = openDropdown === 'resultados' ? null : 'resultados'"
                                class="inline-flex items-center justify-center px-3 py-2 rounded-lg text-sm font-medium transition-all
                                     {{ request()->routeIs('admin.results.*') || request()->routeIs('applicant.results.*')
                            ...
                            Resultados
                            <svg class="w-4 h-4 ml-1 transition-transform" :class="openDropdown === 'resultados' ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                            </svg>
                        </button>

                        <div x-show="openDropdown === 'resultados'"
                             x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 scale-95"
                             x-transition:enter-end="opacity-100 scale-100"
                             x-transition:leave="transition ease-in duration-150"
                            ...
                            <div class="py-1">
                                <a href="{{ route('admin.results.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-amber-50 transition-all group">
                                    ...
                                    <span class="font-medium group-hover:text-yellow-500">Gestión de Resultados</span>
                                </a>
                                <a href="{{ route('applicant.results.index') }}"
                                   class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all group">
                                    <svg class="w-5 h-5 mr-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                    </svg>
                                    <span class="font-medium group-hover:text-green-500">Mis Resultados</span>
                                </a>
                            </div>
                        </div>
                    </div>
